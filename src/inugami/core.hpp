...
public:
	 ...
	 *  @param clearDepth If @a true, clears the depth buffer.
     */
    void applyCam(const Camera& in, bool clearDepth = true);
     ...
     *  @param showFPS Append framerate.
     */
    void setWindowTitle(std::string const& text, bool showFPS = false);

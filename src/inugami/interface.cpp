...
int Interface::ivk(char in) //static
{
...
int Interface::ivkFunc(unsigned long long in) //static
{
...
int Interface::ivkNumpad(char in) //static
{
...
int Interface::ivkNumpad(unsigned long long in) //static
{
	if (in <= 9) return GLFW_KEY_KP_0 + in;
	return 0;
}

int Interface::ivkShift(char in) //static
{
...
int Interface::ivkControl(char in) //static
{
...
int Interface::ivkAlt(char in) //static
{
...
int Interface::ivkArrow(char in) //static
{
	if (in >= 'a' && in <= 'z') in = in - 'a' + 'A';
...
int Interface::ivm(char in) //static
{
	if (in >= 'a' && in <= 'z') in = in - 'a' + 'A';
